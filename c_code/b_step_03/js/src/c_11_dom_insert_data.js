...
var data = [{
  ...
  {
    title: 'banana',
    content: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat!',
    link: 'http://naver.com',
    bgImg: '../multi/img/bottle.jpg',
    bgNarr: '이미지에 대한 간략한 설명'
  },
...
// 시나리오:
// .card 내부에 li 요소 삽입
// 별도의 data 객체를 만들어 해당하는 내용이 li에 첨부
...
for (; i < len; i++) {
  ...
  $makeLi.innerHTML = '<div class="bg_img" style="background-image:url(' + data[i].bgImg + ')"><span class="blind">' + data[i].bgNarr + '</span></div><dl><dt>' + data[i].title + '</dt> <dd><span>' + data[i].content + '</span><br /><a href=\"' + data[i].link + '\" target="_blank">자세히 보기</a></dd></dl>';
...
var setCardFn = function(n){
  ...
  narr.innerText = data[idx].content;
